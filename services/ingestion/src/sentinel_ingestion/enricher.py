...
def enrich(event: SecurityEvent) -> SecurityEvent:
    ...
    attributes["derived"] = {
        ...
        "is_privilege_change": any(term in action for term in ("role", "permission", "grant", "revoke")),
        "is_data_movement": any(term in action for term in ("export", "download", "read", "transfer")),
